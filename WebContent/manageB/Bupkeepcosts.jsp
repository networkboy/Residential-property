	...
	<div id="wide-content">
        ...
        <tr>
          <td width="92"><table width="140" border="1">     
            <tr>
           <td width="163"><span class="mainMenu"><a href="showManageservicefund.action?pageNo=1">管理维修基金</a></span></td>
            </tr>
            <tr>
              <td><span class="mainMenu"><a href="showManageplot.action?pageNo=1">管理小区维护项目</a></span></td>
            </tr>
            <tr>
              <td><span class="mainMenu">维修费用结算</a></span></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
          ...
          <td width="929"><table width="834" height="139" border="1">
            <tr>
              <td width="119">用户名</td>
              <td width="171">地址</td>
               <td width="145">维修费用</td>
              <td width="145">维修日期</td>
              <td width="108">增加</td>
              <td width="106">操作</td>
            </tr>
             <s:iterator value="upkeepcosts">
            <tr>
              <form action="updateupkeepcosts" method="post">
              ...
              <td><a href="deleteupkeepcosts?name=<s:property value="name"/>">删除</a></td>
           ...
           <table width="834" height="139" border="1">
              <tr>
              <form action="addupkeepcosts" method="post">
            ...
            ···································
            <a href="showupkeepcosts?pageNo=1">首页</a>························
            <a href='showupkeepcosts?pageNo=<s:property value="pageNo-1"/>'>上页</a>.........................
            <a href='showupkeepcosts?pageNo=<s:property value="pageNo+1"/>'>下页</a>....................................
            <a href='showupkeepcosts?pageNo=<s:property value="totalPageNum"/>'>末页</a></p>
          </td>
        </tr>
      </table>
		</div>
