	...
	<div id="wide-content">
        ...
        <tr>
          <td width="92"><table width="140" border="1">
            ...
            <tr>
              <td width="163"><span class="mainMenu"><a href="showManagechargemanagement.action?pageNo=1">管理物业收费标准</a></span></td>
            </tr>
            <tr>
              <td>管理房屋信息</a></span></td>
            </tr>
          ...
          <td width="929"><table width="834" height="139" border="1">
            <tr>
              <td width="119">用户名</td>
              <td width="171">地址</td>
               <td width="145">房屋尺寸</td>
              <td width="145">建造日期</td>
              <td width="108">增加</td>
              <td width="106">操作</td>
            </tr>
             <s:iterator value="managehome">
            <tr>
              <form action="updateManagehome" method="post">
              ...
              <td><a href="deleteManagehome?name=<s:property value="name"/>">删除</a></td>
           ...
           <table width="834" height="139" border="1">
              <tr>
              <form action="addManagehome" method="post">
            ...
            ···································
            <a href="showManagehome?pageNo=1">首页</a>························
            <a href='showManagehome?pageNo=<s:property value="pageNo-1"/>'>上页</a>.........................
            <a href='showManagehome?pageNo=<s:property value="pageNo+1"/>'>下页</a>....................................
            <a href='showManagehome?pageNo=<s:property value="totalPageNum"/>'>末页</a></p>
          </td>
        </tr>
      </table>
		</div>
