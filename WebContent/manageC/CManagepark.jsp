	...
	<div id="wide-content">
        ...
        <tr>
          <td width="92"><table width="140" border="1">
            ...
            <tr>
              <td><span class="mainMenu"><a href="showManagepark.action?pageNo=1">管理业主</a></span></td>
            </tr>
            <tr>
              <td><span class="mainMenu">管理停车位</td>
            </tr>
            <tr>
          ...
          <td width="929"><table width="834" height="139" border="1">
            <tr>
              ...
              <td width="171">地址</td>
               <td width="145">车位</td>
              <td width="145">车位租日期</td>
              <td width="108">增加</td>
              <td width="106">操作</td>
            </tr>
             <s:iterator value="managepark">
            <tr>
              <form action="updateManagepark" method="post">
              ...
              <td><a href="deleteManagepark?name=<s:property value="name"/>">删除</a></td>
           ...
           <table width="834" height="139" border="1">
              <tr>
              <form action="addManagepark" method="post">
            ...
            ···································
            <a href="showManagepark?pageNo=1">首页</a>························
            <a href='showManagepark?pageNo=<s:property value="pageNo-1"/>'>上页</a>.........................
            <a href='showManagepark?pageNo=<s:property value="pageNo+1"/>'>下页</a>....................................
            <a href='showManagepark?pageNo=<s:property value="totalPageNum"/>'>末页</a></p>
          </td>
        </tr>
      </table>
		</div>
