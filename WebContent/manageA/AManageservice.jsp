	...
	<div id="wide-content">
        ...
        <tr>
          <td width="92"><table width="140" border="1">
            ...
            <tr>
              <td width="163"><span class="mainMenu"><a href="showManageowner.action">物业业主缴纳费用</a></span></td>
            </tr>
            <tr>
              <td><span class="mainMenu">维修信息</a></span></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
          ...
          <td width="929"><table width="834" height="139" border="1">
            <tr>
             ...
             <s:iterator value="manageservice">
            <tr>
              <form action="updateManageservice" method="post">
              ...
              <td><a href="deleteManageservice?name=<s:property value="name"/>">删除</a></td>
           ...
           <table width="834" height="139" border="1">
              <tr>
              <form action="addManageservice" method="post">
            ...
            ···································
            <a href="showManageservice?pageNo=1">首页</a>························
            <a href='showManageservice?pageNo=<s:property value="pageNo-1"/>'>上页</a>.........................
            <a href='showManageservice?pageNo=<s:property value="pageNo+1"/>'>下页</a>....................................
            <a href='showManageservice?pageNo=<s:property value="totalPageNum"/>'>末页</a></p>
          </td>
        </tr>
      </table>
		</div>
