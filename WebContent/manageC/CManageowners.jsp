	...
	<div id="wide-content">
        ...
        <tr>
          <td width="92"><table width="140" border="1">
            ...
            <tr>
              <td><span class="mainMenu">管理业主</td>
            </tr>
            <tr>
          ...
          <td width="929"><table width="834" height="139" border="1">
            <tr>
             ...
             <s:iterator value="manageowners">
            <tr>
              <form action="updateManageowners" method="post">
              ...
              <td><a href="deleteManageowners?name=<s:property value="name"/>">删除</a></td>
           ...
           <table width="834" height="139" border="1">
              <tr>
              <form action="addManageowners" method="post">
            ...
            ···································
            <a href="showManageowners?pageNo=1">首页</a>························
            <a href='showManageowners?pageNo=<s:property value="pageNo-1"/>'>上页</a>.........................
            <a href='showManageowners?pageNo=<s:property value="pageNo+1"/>'>下页</a>....................................
            <a href='showManageowners?pageNo=<s:property value="totalPageNum"/>'>末页</a></p>
          </td>
        </tr>
      </table>
		</div>
