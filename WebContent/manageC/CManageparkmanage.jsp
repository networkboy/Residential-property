	...
	<div id="wide-content">
        ...
        <tr>
          <td width="92"><table width="140" border="1">
            ...
            <tr>
              <td width="163"><a href="showManagechargemanagement.action?pageNo=1">管理物业收费标准</a></span></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><span class="mainMenu">管理停车位收费标准</td>
            </tr>
            <tr>
              <td><span class="mainMenu"><a href="showManageuser.action?pageNo=1">管理用户</a></span></td>
            </tr>
            <tr>
          ...
          <td width="929"><table width="834" height="139" border="1">
            <tr>
              <td width="119">车位收费</td>
              <td width="171">车位</td>
               <td width="145">收费</td>
              <td width="145">收费日期</td>
              <td width="108">增加</td>
              <td width="106">操作</td>
            </tr>
             <s:iterator value="manageparkmanage">
            <tr>
              <form action="updateManageparkmanage" method="post">
              ...
              <td><a href="deleteManageparkmanage?name=<s:property value="name"/>">删除</a></td>
           ...
           <table width="834" height="139" border="1">
              <tr>
              <form action="addManageparkmanage" method="post">
            ...
            ···································
            <a href="showManageparkmanage?pageNo=1">首页</a>························
            <a href='showManageparkmanage?pageNo=<s:property value="pageNo-1"/>'>上页</a>.........................
            <a href='showManageparkmanage?pageNo=<s:property value="pageNo+1"/>'>下页</a>....................................
            <a href='showManageparkmanage?pageNo=<s:property value="totalPageNum"/>'>末页</a></p>
          </td>
        </tr>
      </table>
		</div>
