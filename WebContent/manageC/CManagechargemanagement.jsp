	...
	<div id="wide-content">
        ...
        <tr>
          ...
          <td width="929"><table width="834" height="139" border="1">
            <tr>
              <td width="119">物业收费</td>
              <td width="171">项目</td>
               <td width="145">收费</td>
              <td width="145">维修时间</td>
              <td width="108">增加</td>
              <td width="106">操作</td>
            </tr>
             <s:iterator value="managechargemanagement">
            <tr>
              <form action="updateManagechargemanagement" method="post">
              ...
              <td><a href="deleteManagechargemanagement?name=<s:property value="name"/>">删除</a></td>
           ...
           <table width="834" height="139" border="1">
              <tr>
              <form action="addManagechargemanagement" method="post">
            ...
            ···································
            <a href="showManagechargemanagement?pageNo=1">首页</a>························
            <a href='showManagechargemanagement?pageNo=<s:property value="pageNo-1"/>'>上页</a>.........................
            <a href='showManagechargemanagement?pageNo=<s:property value="pageNo+1"/>'>下页</a>....................................
            <a href='showManagechargemanagement?pageNo=<s:property value="totalPageNum"/>'>末页</a></p>
          </td>
        </tr>
      </table>
		</div>
