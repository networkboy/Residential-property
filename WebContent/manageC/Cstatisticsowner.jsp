	...
	<div id="wide-content">
        ...
        <tr>
          <td width="92"><table width="140" border="1">
            ...
            <tr>
              <td><span class="mainMenu">统计物业费缴纳情况</span></td>
            </tr>
            <tr>
          ...
          <td width="929"><table width="834" height="139" border="1">
            <tr>
              <td width="119">用户名</td>
              <td width="171">地址</td>
               <td width="145">缴费金额</td>
              <td width="145">缴费日期</td>
              <td width="108">增加</td>
              <td width="106">操作</td>
            </tr>
             <s:iterator value="statisticsowners">
            <tr>
              <form action="updatestatisticsowner" method="post">
              ...
              <td><a href="deletestatisticsowner?name=<s:property value="name"/>">删除</a></td>
           ...
           <table width="834" height="139" border="1">
              <tr>
              <form action="addstatisticsowner" method="post">
            ...
            ···································
            <a href="showstatisticsowner?pageNo=1">首页</a>························
            <a href='showstatisticsowner?pageNo=<s:property value="pageNo-1"/>'>上页</a>.........................
            <a href='showstatisticsowner?pageNo=<s:property value="pageNo+1"/>'>下页</a>....................................
            <a href='showstatisticsowner?pageNo=<s:property value="totalPageNum"/>'>末页</a></p>
          </td>
        </tr>
      </table>
		</div>
