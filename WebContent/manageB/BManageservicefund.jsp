	...
	<div id="wide-content">
        ...
        <tr>
          <td width="92"><table width="140" border="1">
            ...
            <tr>
              <td width="163"><span class="mainMenu">管理维修基金</span></td>
            </tr>
            <tr>
              <td><span class="mainMenu"><a href="showManageplot.action?pageNo=1">管理小区维护项目</a></span></td>
            </tr>
            <tr>
              <td><span class="mainMenu"><a href="showupkeepcosts.action?pageNo=1">维修费用结算</a></span></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
          ...
          <td width="929"><table width="834" height="139" border="1">
            <tr>
              <td width="119">用户名</td>
              <td width="171">地址</td>
               <td width="145">维修状态</td>
              <td width="145">维修日期</td>
              <td width="108">增加</td>
              <td width="106">操作</td>
            </tr>
             <s:iterator value="manageservicefund">
            <tr>
              <form action="updateManageservicefund" method="post">
              ...
              <td><a href="deleteManageservicefund?name=<s:property value="name"/>">删除</a></td>
           ...
           <table width="834" height="139" border="1">
              <tr>
              <form action="addManageservicefund" method="post">
            ...
            ···································
            <a href="showManageservicefund?pageNo=1">首页</a>························
            <a href='showManageservicefund?pageNo=<s:property value="pageNo-1"/>'>上页</a>.........................
            <a href='showManageservicefund?pageNo=<s:property value="pageNo+1"/>'>下页</a>....................................
            <a href='showManageservicefund?pageNo=<s:property value="totalPageNum"/>'>末页</a></p>
          </td>
        </tr>
      </table>
		</div>
